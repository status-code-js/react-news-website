export const esData = {
    ...
    main: {
        ...
        sidebar: {
            text1: "Suscríbete a la revista Impuls",
            text2: "Un boletín semanal de primicias, análisis e información exclusiva sobre lo que está sucediendo en la Comunidad Valenciana y más allá del equipo de informes",
            text3: "Lo más leído",
            button: "Suscríbete",
            popular: [
                {
    ...
    footer: {
        link1: "Condiciones de servicio",
        link2: "Administrar cookies",
